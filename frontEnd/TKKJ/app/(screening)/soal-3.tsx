...
export default function Soal3Screen() {
    ...
    const audioFiles = [
        require('../../assets/audio/3_b.mpeg'), // misal: "api"
        require('../../assets/audio/3_a.mpeg'), // misal: "opi" (Benar)
        require('../../assets/audio/3_t.mpeg'), // misal: "upi"
        require('../../assets/audio/3_u.mpeg'), // misal: "epo"
    ];
    ...
    async function playSound(index: number) {
        ...
        if (!audioFiles[index]) {
            alert("File audio belum tersedia di folder assets.");
            return;
        }
        if (sound) {
    ...
    const handleLanjut = () => {
        // Cek jawaban: benar jika "batu"
        const isCorrect = jawaban.toLowerCase().trim() === 'batu';
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <LinearGradient colors={['#FDFDE1', '#F4FBE4']} style={styles.container}>
                ...
                <TouchableOpacity
                    ...
                    onPress={handleLanjut} // Panggil fungsi yang baru dibuat
